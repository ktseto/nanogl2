...
extern "C" {
    ...
    JNIEXPORT void JNICALL Java_com_android_gl2jni_GL2JNILib_setRotation(JNIEnv *env, jobject obj, jfloat _rotation);
    ...
    JNIEXPORT void JNICALL Java_com_android_gl2jni_GL2JNILib_setTranslation(JNIEnv *env, jobject obj, jfloat _x, jfloat _y);
};
